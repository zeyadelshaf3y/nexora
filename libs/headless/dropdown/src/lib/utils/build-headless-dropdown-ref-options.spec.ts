...
function minimalInput(
  ...
  return {
    ...
    baseBackdropClass: 'nxr-test-backdrop',
...
describe('buildHeadlessDropdownRefOptions', () => {
  ...
  it('merges baseBackdropClass with user backdropClass', () => {
    const opts = buildHeadlessDropdownRefOptions(
      minimalInput({
        baseBackdropClass: 'nxr-select-backdrop',
        backdropClass: () => ['app-backdrop'],
      }),
    );
    expect(opts.backdropClass?.()).toEqual(['nxr-select-backdrop', 'app-backdrop']);
  });
