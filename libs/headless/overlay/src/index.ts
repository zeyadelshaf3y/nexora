...
} from './lib/services/overlay-defaults.config';
...
export {
  ...
  type DialogDefaultsConfig,
  type DrawerDefaultsConfig,
} from './lib/services/panel-services-defaults.config';
