...
- Fix hover pointer highlight so select/combobox keep the last hovered option for keyboard navigation. ([319f175](https://github.com/zeyadelshaf3y/nexora/commit/319f175))
