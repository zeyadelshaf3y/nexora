...
import { provideComboboxDefaults } from './combobox-defaults.config';
...
@Component({
  ...
  providers: [
    ...
    provideComboboxDefaults({
      backdropClass: 'defaults-combobox-backdrop',
    }),
  ],
  template: `
    <nxr-combobox
      [hasBackdrop]="true"
      backdropClass="instance-combobox-backdrop"
      nxrBackdropClass="instance-combobox-nxr-backdrop"
      [closeAnimationDurationMs]="0"
      #combo="nxrCombobox"
    >
      <input nxrComboboxInput />
...
export class ComboboxBackdropDefaultsPrecedenceHostComponent {
  readonly comboRef = viewChild.required<ComboboxComponent<unknown>>('combo');
}
