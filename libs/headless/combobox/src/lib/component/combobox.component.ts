...
import {
  ...
  DEFAULT_COMBOBOX_DEFAULTS_CONFIG,
} from './combobox-defaults.config';
...
export class ComboboxComponent<T = unknown> implements ComboboxController, ControlValueAccessor {
  ...
  private readonly defaults = {
    ...DEFAULT_COMBOBOX_DEFAULTS_CONFIG,
    hasBackdrop: this.overlayDefaults.hasBackdrop ?? DEFAULT_COMBOBOX_DEFAULTS_CONFIG.hasBackdrop,
    closeAnimationDurationMs:
      this.overlayDefaults.closeAnimationDurationMs ??
      DEFAULT_COMBOBOX_DEFAULTS_CONFIG.closeAnimationDurationMs,
    maintainInViewport:
      this.overlayDefaults.maintainInViewport ??
      DEFAULT_COMBOBOX_DEFAULTS_CONFIG.maintainInViewport,
    boundaries: this.overlayDefaults.boundaries ?? DEFAULT_COMBOBOX_DEFAULTS_CONFIG.boundaries,
    ...
    ...(inject(COMBOBOX_DEFAULTS_CONFIG, { optional: true }) ?? {}),
  };
  ...
  readonly hasBackdrop = input(this.defaults.hasBackdrop ?? false);
  ...
  readonly maxHeight = input(this.defaults.maxHeight ?? DEFAULT_MAX_HEIGHT);
  ...
  readonly scrollStrategy = input<ComboboxScrollStrategy>(this.defaults.scrollStrategy ?? 'noop');
  readonly maintainInViewport = input(this.defaults.maintainInViewport ?? true);
  ...
  readonly openPanelOnFocus = input(this.defaults.openPanelOnFocus ?? true);
